...
class CircularNotchedRoundedRectangle extends NotchedShape {
  final double radius;

  /// Creates a [CircularNotchedRectangle].
  ///
  /// The same object can be used to create multiple shapes.
  const CircularNotchedRoundedRectangle(this.radius);
  ...
  Path getOuterPath(Rect host, Rect? guest) {
    ...
    return Path()
      ...
      ..arcTo(Rect.fromLTWH(host.left, host.top, radius, radius),
          degreeToRadians(180), degreeToRadians(90), false)
      ...
      ..arcTo(Rect.fromLTWH(host.right - radius, host.top, radius, radius),
