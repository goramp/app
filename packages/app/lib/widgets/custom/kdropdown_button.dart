...
///
/// Used by [KDropdownButton.selectedItemBuilder].
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    // the menu does not extend sell the left and right edges of the screen.
...
class _DropdownRoutePage<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // KDropdownButton.itemHeight is specified or KDropdownButton.itemHeight is null
...
// The container widget for a menu item created by a [KDropdownButton]. It
// provides the default configuration for [DropdownMenuItem]s, as well as a
// [KDropdownButton]'s hint and disabledHint widgets.
...
///
/// {@tool dartpad}
/// This sample shows a `KDropdownButton` with a large arrow icon,
...
class KDropdownButton<T> extends StatefulWidget {
  ...
  KDropdownButton({
    ...
    // KDropdownButtonFormField.
              ...
              items.where((DropdownMenuItem<T> item) {
                ...
                "There should be exactly one item with [KDropdownButton]'s value: "
                '$value. \n'
  ...
  ///
  /// If the [onChanged] callback is null or the list of [KDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [KDropdownButton.disabledHint] widget if it is non-null.
  /// If [KDropdownButton.disabledHint] is also null but [KDropdownButton.hint] is
  /// non-null, [KDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows a `KDropdownButton` with a button with [Text] that
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows a `KDropdownButton` with a dropdown button text style
  ...
  @override
  State<KDropdownButton<T>> createState() => _DropdownButtonState<T>();
}

class _DropdownButtonState<T> extends State<KDropdownButton<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
  ...
  @override
  void didUpdateWidget(KDropdownButton<T> oldWidget) {
...
/// A [FormField] that contains a [KDropdownButton].
///
/// This is a convenience widget that wraps a [KDropdownButton] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [KDropdownButton], which is the underlying text field without the [Form]
///    integration.
class KDropdownButtonFormField<T> extends FormField<T> {
  /// Creates a [KDropdownButton] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
...
class _DropdownButtonFormFieldState<T> extends FormFieldState<T> {
  @override
  KDropdownButtonFormField<T> get widget => super.widget as KDropdownButtonFormField<T>;
  ...
  @override
  void didUpdateWidget(KDropdownButtonFormField<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
