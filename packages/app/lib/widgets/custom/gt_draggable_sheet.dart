...
/// [Axis] of the containing [GtDraggableScrollableSheet].
///
...
/// sheet be draggable.
typedef GtScrollableWidgetBuilder = Widget Function(
...
/// [GtScrollableWidgetBuilder] does not use the provided [ScrollController], the
...
///     return Scaffold(
///       appBar: AppBar(
///         title: const Text('GtDraggableScrollableSheet'),
///       ),
///       body: SizedBox.expand(
///         child: GtDraggableScrollableSheet(
...
class GtDraggableScrollableSheet extends StatefulWidget {
  ...
  /// of the contents.
  final GtScrollableWidgetBuilder builder;
...
/// [GtDraggableScrollableSheet].
///
/// [GtDraggableScrollableSheet] widgets notify their ancestors when the size of
...
/// [GtDraggableScrollableSheet] widgets. To focus on notifications from the
/// nearest [GtDraggableScrollableSheet] descendant, check that the [depth]
...
class GtDraggableScrollableNotification extends Notification
    with ViewportNotificationMixin {
  /// Creates a notification that the extent of a [GtDraggableScrollableSheet] has
  /// changed.
  ///
  ...
  GtDraggableScrollableNotification({
...
class _DraggableScrollableSheetState extends State<GtDraggableScrollableSheet> {
...
/// A [ScrollController] suitable for use in a [GtScrollableWidgetBuilder] created
/// by a [GtDraggableScrollableSheet].
///
/// If a [GtDraggableScrollableSheet] contains content that is exceeds the height
...
/// A widget that can notify a descendent [GtDraggableScrollableSheet] that it
...
class GtDraggableScrollableActuator extends StatelessWidget {
  /// Creates a widget that can notify descendent [GtDraggableScrollableSheet]s
  /// to reset to their initial position.
  ///
  /// The [child] parameter is @required.
  GtDraggableScrollableActuator({
    Key? key,
    required this.child,
  }) : super(key: key);

  /// This child's [GtDraggableScrollableSheet] descendant will be reset when the
  ...
  /// Notifies any descendant [GtDraggableScrollableSheet] that it should reset
  /// to its initial position.
  ///
  /// Returns `true` if a [GtDraggableScrollableActuator] is available and
  /// some [GtDraggableScrollableSheet] is listening for updates, `false`
  /// otherwise.
...
class _InheritedResetNotifier extends InheritedNotifier<_ResetNotifier> {
  /// Creates an [InheritedNotifier] that the [GtDraggableScrollableSheet] will
  ...
  /// Specifies whether the [GtDraggableScrollableSheet] should reset to its
  /// initial position.
  ///
