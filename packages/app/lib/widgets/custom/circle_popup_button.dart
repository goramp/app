...
class CirclePopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const CirclePopupMenuButton({
    Key? key,
...
/// The [State] for a [CirclePopupMenuButton].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class PopupMenuButtonState<T> extends State<CirclePopupMenuButton<T>> {
  final GlobalKey _menuButtonKey = GlobalKey();

  /// A method to show a popup menu with the items supplied to
  /// [CirclePopupMenuButton.itemBuilder] at the position of your [CirclePopupMenuButton].
  ///
  /// By default, it is called when the user taps the button and [CirclePopupMenuButton.enabled]
        ...
        return UnconstrainedBox(
          ...
          child: LimitedBox(
            ...
            child: ButtonTheme.fromButtonThemeData(
              data: theme.copyWith(minWidth: 48.0),
              child: TextButton(
                key: _menuButtonKey,
