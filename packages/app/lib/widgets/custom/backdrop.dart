...
const double _kFrontClosedHeight = 0.0; // front layer height when closed
const double _kBackAppBarHeight = 56.0; // back layer (options) appbar height
const double _kPanelHeight = 261.0;
...
class _BackdropState extends State<Backdrop>
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    final double top = screenHeight - _kPanelHeight;
    final Animation<RelativeRect> frontRelativeRect =
        _controller!.drive(RelativeRectTween(
      begin: RelativeRect.fromLTRB(0.0, constraints.biggest.height, 0.0, 0.0),
