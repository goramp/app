...
class _DefaultHeroTag {
  ...
  @override
  String toString() => '<default CustomFloatingActionButton tag>';
}
...
/// most commonly used in the [Scaffold.CustomFloatingActionButton] field.
///
...
/// This example shows how to display a [CustomFloatingActionButton] in a
...
///
/// {@tool dartpad --template=stateless_widget_material}
/// This example shows how to make an extended [CustomFloatingActionButton] in a
...
///     ),
///     CustomFloatingActionButton: CustomFloatingActionButton.extended(
///       onPressed: () {
///         // Add your onPressed code here!
///       },
///       label: Text('Approve'),
...
class CustomFloatingActionButton extends StatelessWidget {
  ...
  CustomFloatingActionButton.extended({
    ...
    this.focusNode,
    this.autofocus = false,
    BoxConstraints constraints = _kExtendedSizeConstraints,
    Widget? icon,
  ...
  /// The splash color for this [CustomFloatingActionButton]'s [InkWell].
  ///
  ...
  /// [CustomFloatingActionButton] per route (that is, per screen), since otherwise
  ...
  /// and have been created with the [CustomFloatingActionButton.extended]
  /// constructor.
  ///
