...
/// An interactive button within either material's [BottomBar]
...
class BottomBarItem {
  /// Creates an item that is used with [BottomBar.items].
  ///
  /// The argument [icon] should not be null and the argument [title] should not be null when used in a Material Design's [BottomBar].
  const BottomBarItem({
    required this.icon,
    this.title,
    Widget? activeIcon,
  ...
  /// See also:
  ///
  ///  * [BottomBarItem.icon], for a description of how to pair icons.
  final Widget activeIcon;

  /// The title of the item. If the title is not provided only the icon will be shown when not used in a Material Design [BottomBar].
  final Widget? title;

  /// The color of the background radial animation for material [BottomBar].
  ///
  /// If the navigation bar's type is [BottomBarType.shifting], then
  /// the entire bar is flooded with the [backgroundColor] when this item is
  /// tapped. This will override [BottomBar.backgroundColor].
  ///
...
/// Defines the layout and behavior of a [BottomBar].
///
/// See also:
///
///  * [BottomBar]
...
enum BottomBarType {
  /// The [BottomBar]'s [BottomBarItem]s have fixed width.
  fixed,

  /// The location and size of the [BottomBar] [BottomBarItem]s
...
/// [BottomBarType.fixed] when there are less than four items, and
/// [BottomBarType.shifting] otherwise.
///
///  * [BottomBarType.fixed], the default when there are less than
...
///  * [BottomBarType.shifting], the default when there are four
...
///    [BottomBarItem.backgroundColor] of the selected item. In this
///    case it's assumed that each item will have a different background color
///    and that background color will contrast well with white.
///
/// {@tool snippet --template=stateful_widget_material}
/// This example shows a [BottomBar] as it is used within a [Scaffold]
/// widget. The [BottomBar] has three [BottomBarItem]
...
///   return Scaffold(
///     appBar: AppBar(
///       title: const Text('BottomBar Sample'),
///     ),
///     body: Center(
...
class BottomBar extends StatefulWidget {
  ...
  /// must not be null.
  ///
  /// If [type] is null then [BottomBarType.fixed] is used when there
  /// are two or three [items], [BottomBarType.shifting] otherwise.
  ///
  ...
  /// [BottomBarType.fixed] and `false` if [type] is
  /// [BottomBarType.shifting].
  BottomBar({
    Key? key,
    required this.items,
  ...
  /// track of the index of the selected [BottomBarItem] and call
  /// `setState` to rebuild the bottom navigation bar with the new [currentIndex].
  final ValueChanged<int>? onTap;

  /// The index into [items] for the current active [BottomBarItem].
  final int currentIndex;

  /// The z-coordinate of this [BottomBar].
  ///
  ...
  /// Defines the layout and behavior of a [BottomBar].
  ///
  /// See documentation for [BottomBarType] for information on the
  ...
  /// The color of the [BottomBar] itself.
  ///
  /// If [type] is [BottomBarType.shifting] and the
  /// [items]s, have [BottomBarItem.backgroundColor] set, the [item]'s
  /// backgroundColor will splash and overwrite this color.
  final Color? backgroundColor;

  /// The size of all of the [BottomBarItem] icons.
  ///
  /// See [BottomBarItem.icon] for more information.
  final double iconSize;

  /// The color of the selected [BottomBarItem.icon] and
  /// [BottomBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color? selectedItemColor;

  /// The color of the unselected [BottomBarItem.icon] and
  /// [BottomBarItem.label]s.
  ///
  ...
  /// The [TextStyle] of the [BottomBarItem] labels when they are
  /// selected.
  final TextStyle? selectedLabelStyle;

  /// The [TextStyle] of the [BottomBarItem] labels when they are not
  /// selected.
  final TextStyle? unselectedLabelStyle;

  /// The font size of the [BottomBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [BottomBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [BottomBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [BottomBarItem]s.
  final bool showSelectedLabels;

  // Used by the [BottomBar] constructor to set the [type] parameter.
  //
  // If type is provided, it is returned. Otherwise,
  // [BottomBarType.fixed] is used for 3 or fewer items, and
  // [BottomBarType.shifting] is used for 4+ items.
  static BottomBarType _type(
    BottomBarType? type,
    ...
    return items.length <= 3 ? BottomBarType.fixed : BottomBarType.shifting;
  }

  static double height(BuildContext context, {double fontSize = 22.0}) {
    final double additionalBottomPadding =
        math.max(MediaQuery.of(context).padding.bottom - fontSize / 2.0, 0.0);
    print("additionalBottomPadding $additionalBottomPadding");
    return kBottomNavigationBarHeight;
  }

  // Used by the [BottomBar] constructor to set the [showUnselected]
  // parameter.
  //
  // Unselected labels are shown by default for [BottomBarType.fixed],
  // and hidden by default for [BottomBarType.shifting].
  static bool _defaultShowUnselected(BottomBarType type) {
    switch (type) {
      case BottomBarType.shifting:
        return false;
      case BottomBarType.fixed:
        return true;
    }
    assert(false);
    return false;
