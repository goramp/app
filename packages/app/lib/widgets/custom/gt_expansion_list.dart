...
class GTExpansionPanelList extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const GTExpansionPanelList({
    Key? key,
  ...
  ///
  /// Here is a simple example of how to implement GTExpansionPanelList.radio.
  ///
  /// ```dart preamble
  ...
  ///
  /// Widget _buildPanel() {
  ///   return GTExpansionPanelList.radio(
  ...
  /// ```
  /// {@end-tool}
  const GTExpansionPanelList.radio({
    Key? key,
  ...
  ///
  /// If GTExpansionPanelList.radio is used, the callback may be called a
  /// second time if a different panel was previously open. The arguments
  /// passed to the second callback are the index of the panel that will close
  /// and false, marking that it will be closed.
  ///
  /// For GTExpansionPanelList, the callback needs to setState when it's notified
  /// about the closing/opening panel. On the other hand, the callback for
  /// GTExpansionPanelList.radio is simply meant to inform the parent widget of
  ...
  /// only used when initializing with the [GTExpansionPanelList.radio]
  /// constructor.)
...
class _ExpansionPanelListState extends State<GTExpansionPanelList> {
  ...
  @override
  void didUpdateWidget(GTExpansionPanelList oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(),
          'All ExpansionPanelRadio identifier values must be unique.');
      // If the previous widget was non-radio GTExpansionPanelList, initialize the
